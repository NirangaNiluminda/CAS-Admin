...
import { useEssay } from '@/app/context/EssayContext';
...
export default function Page() {
    ...
    const { quiz } = useQuiz();
    const [essayResults, setEssayResults] = useState<EssayResult | null>(null);
    const [loading, setLoading] = useState(true);
    const router = useRouter();
    const [essayData, setEssayData] = useState<EssayAnswer[]>([]);
    ...
    useEffect(() => {
        const fetchResults = async () => {
            ...
            try {
                // Use the essay-specific endpoint
                const response = await fetch(`${apiUrl}/api/v1/essay/viewResult/${id}/student/${sid}`, {
                    headers: {
                ...
                if (data.results && data.results.answers) {
                    // Add any processing needed for essay answers
                    setEssayResults(data.results);
                    setEssayData(data.results.answers);
                }

                // Set registration number if available
                setRegNum(data.results.registrationNumber || null);
                ...
                if (data.essayInfo && setEssay) {
                    setEssay(data.essayInfo);
                  }
            } catch (error) {
                console.error('Failed to fetch essay results:', error);
            } finally {
                setLoading(false);
            }
        };
    ...
    const getViolationIcon = (type: string) => {
        const iconMap: Record<string, React.ReactNode> = {
            ...
            "Similarity Violation": <AlertTriangle size={18} />
        };
        ...
        return (
            <div className="min-h-screen bg-gradient-to-b from-green-50 to-white flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-green-700 font-medium">Loading student essay results...</p>
                </div>
            </div>
        );
    }
                ...
                <Card className="w-full max-w-md shadow-lg border-red-200">
                    <CardHeader className="bg-red-50">
                        <CardTitle className="text-red-700 flex items-center gap-2">
                            ...
                            No Essay Results Found
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="pt-6">
                        <p className="text-gray-600 mb-4">
                            No essay results could be found for this student. They may not have completed the essay yet.
                        </p>
                        <Button
                ...
                >
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Essay Result</h1>
                                <p className="text-gray-500">Viewing detailed essay performance analysis</p>
                            </div>
                        </div>
                        ...
                        <CardContent className="p-0">
                            <div className="flex flex-col md:flex-row">
                                <div className="w-full md:w-1/3 bg-gradient-to-br from-green-400 to-emerald-600 p-8 flex flex-col justify-center items-center text-white">
                                    ...
                                    <Badge className="bg-white/20 backdrop-blur-sm text-white border-0 mt-2">
                                        {studentDetails.registrationNumber || `ID: ${typeof studentDetails.id === 'string' ? studentDetails.id.substring(0, 8) : 'N/A'}...`}
                                    </Badge>
                                </div>
                                ...
                                <div className="w-full md:w-2/3 p-8">
                                    ...
                                    <div className="mb-6">
                                        <div className="flex justify-between mb-2">
                                            ...
                                            <span className="text-sm font-medium">
                                                {essayResults.similarityScore ? `${(essayResults.similarityScore * 100).toFixed(0)}%` : 'N/A'}
                                            </span>
                                        </div>
                                        <Progress
                                            value={essayResults.similarityScore ? essayResults.similarityScore * 100 : 0}
                                            className="h-2"
                                        />
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h4 className="font-medium text-gray-800">{essayResults.timeTaken.toFixed(2)} min</h4>
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h4 className="font-medium text-gray-800">{formatDate(essayResults.submittedAt)}</h4>
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h4 className="font-medium text-gray-800">
                                                    {essayResults.similarityScore
                                                        ? `${(essayResults.similarityScore * 100).toFixed(0)}%`
                                                        : 'N/A'}
                                                </h4>
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h4 className="font-medium text-gray-800">{essayResults.score.toFixed(2)}</h4>
                    ...
                    <Card className="shadow-xl border-0 overflow-hidden">
                        <Tabs defaultValue={activeTab} onValueChange={setActiveTab} className="w-full">
                            ...
                            <CardContent className="pt-6">
                                <TabsContent value="essay" className="m-0">
                                    <div className="mb-4 flex items-center justify-between">
                                        ...
                                        <div className="flex items-center">
                                            <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200">
                                                ...
                                                Similarity: {essayResults.similarityScore
                                                    ? `${(essayResults.similarityScore * 100).toFixed(0)}%`
                                                    : 'N/A'
                                                }
                                            </Badge>
                                                        ...
                                                        <div>
                                                            ...
                                                            {answer.questionText && (
                                                                <div className="mb-4 bg-gray-50 p-3 rounded-md border border-gray-200">
                                                                    <p className="text-gray-600">{answer.questionText}</p>
                                                                </div>
                                                            )}
                                                            ...
                                                            <div>
                                                                ...
                                                                <h5 className="text-sm font-medium text-gray-600 mb-2">Model Answer:</h5>
                                                                <div className="p-4 bg-green-50 rounded-md border border-green-200 mb-2 whitespace-pre-wrap">
                                                                    {answer.modelAnswer}
                                                                </div>
                                                                ...
                                                                <div className="flex items-center justify-between mt-4">
                                                                    <Badge
                                                                        variant="outline"
                                                                        className={`${answer.similarityScore
                                                                            ? getSimilarityColor(answer.similarityScore)
                                                                            : "text-gray-600"
                                                                            } bg-white border`}
                                                                    >
                                                                        Similarity Score:{" "}
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <div>
                                                        <div className="flex justify-between items-center mb-1">
                                                            ...
                                                            <span className="text-sm font-medium">{essayResults.score.toFixed(2)}/100</span>
                                                        </div>
                                                        <Progress value={(essayResults.score)} className="h-2 bg-gray-100" />
                                                    </div>

                                                    <div className="pt-2">
                                                        <h4 className="text-sm font-medium text-gray-700 mb-3">Essay Details</h4>
                                                        <div className="space-y-2">
                                                            <div className="flex justify-between items-center">
                                                                ...
                                                                <div className="text-sm font-medium">
                                                                    {essayData[0]?.studentAnswer
                                                                        ? essayData[0].studentAnswer.split(/\s+/).filter(Boolean).length
                                                                        : 'N/A'}
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="flex justify-between items-center">
                                                                ...
                                                                <div className="text-sm font-medium">
                                                                    {essayData[0]?.studentAnswer
                                                                        ? `${essayData[0].studentAnswer.length} characters`
                                                                        : 'N/A'}
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="flex justify-between items-center">
                                                                ...
                                                                <div className="text-sm font-medium">{essayData.length}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="space-y-4">
                                                    <div>
                                                        <div className="flex justify-between items-center mb-1">
                                                            ...
                                                            <span className="text-sm font-medium">
                                                                {essayResults.timeTaken.toFixed(2)} min
                                                            </span>
                                                        </div>
                                                        <Progress
                                                            value={(essayResults.timeTaken / (quiz?.timeLimit || essayResults.timeTaken * 1.5)) * 100}
                                                            className="h-2 bg-gray-100"
                                                        />
                                                        {quiz?.timeLimit && (
                                                        ...
                                                        <div className="grid grid-cols-2 gap-3">
                                                            <div className="rounded-lg border border-gray-200 p-3">
                                                                ...
                                                                <div className="text-lg font-semibold text-gray-800">
                                                                    {(essayResults.timeTaken / essayData.length).toFixed(1)} min
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="rounded-lg border border-gray-200 p-3">
                                                                ...
                                                                <div className="text-lg font-semibold text-gray-800">
                                                                    {essayResults.timeTaken.toFixed(1)} min
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="rounded-lg border border-gray-200 p-3">
                                                                ...
                                                                <div className="text-sm font-medium text-gray-800">
                                                                    {new Date(essayResults.submittedAt).toLocaleDateString()}
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="rounded-lg border border-gray-200 p-3">
                                                                ...
                                                                <div className="text-sm font-medium text-gray-800">
                                                                    {new Date(essayResults.submittedAt).toLocaleTimeString()}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    {/* Mobile Action Button for Print - Only visible on small screens */}
